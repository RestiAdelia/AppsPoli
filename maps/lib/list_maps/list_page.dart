...
class ListPage extends StatelessWidget {
  final List<LocationItem> locations = [
    LocationItem(
      ...
      rating: 4.7,
      descripsi: "RSUP Dr. M. Djamil adalah rumah sakit rujukan utama di Sumatera Barat dan merupakan rumah sakit kelas A. Melayani pasien dari berbagai daerah, rumah sakit ini memiliki berbagai fasilitas unggulan dan tenaga medis sub-spesialis yang lengkap."
    ),
    LocationItem(
    ...
    LocationItem(
      ...
      longitude: 100.3659,
      rating: 4.4,
        descripsi: "RS Ibnu Sina Padang merupakan rumah sakit swasta yang memberikan pelayanan kesehatan umum dan spesialis. Rumah sakit ini dikenal dengan layanan rawat inap, rawat jalan, serta unit gawat darurat yang responsif dan profesional."
    ),
    LocationItem(
      ...
      rating: 4.8,
        descripsi: "RS Yos Sudarso adalah rumah sakit swasta yang telah berdiri sejak lama di Kota Padang. Rumah sakit ini menyediakan berbagai layanan spesialis, termasuk bedah, penyakit dalam, dan layanan radiologi, dengan komitmen tinggi terhadap keselamatan dan kenyamanan pasien."
    ),
    LocationItem(
        ...
        rating: 4.2,
        descripsi: "RSUD Dr. Rasidin merupakan rumah sakit milik pemerintah kota Padang. Rumah sakit ini menjadi rujukan untuk pelayanan kesehatan dasar hingga lanjutan dengan berbagai layanan spesialis dan fasilitas penunjang yang terus berkembang."
    ),
    LocationItem(
        ...
        rating: 4.7,
        descripsi: "Rumah Sakit Semen Padang adalah rumah sakit swasta milik PT Semen Padang yang telah menjadi salah satu fasilitas kesehatan unggulan di Sumatera Barat. Rumah sakit ini melayani masyarakat umum dan karyawan perusahaan, dengan layanan spesialis dan peralatan medis modern."
    ),
    LocationItem(
    ...
    LocationItem(
        ...
        rating: 4.4,
        descripsi: "Rumah Sakit Tentara (RST) Dr. Reksodiwiryo adalah rumah sakit milik TNI AD yang melayani prajurit TNI, keluarga, serta masyarakat umum. Rumah sakit ini memiliki layanan kesehatan yang lengkap dan menjadi salah satu pusat rujukan di wilayah militer."
    ),
    LocationItem(
        ...
        rating: 4.5,
        descripsi: "Rumah Sakit Hermina Padang adalah bagian dari jaringan Rumah Sakit Hermina Group yang dikenal secara nasional. Rumah sakit ini menyediakan layanan kesehatan ibu dan anak, serta spesialis lainnya, dengan fasilitas yang modern dan pelayanan ramah."
    ),
  ];
